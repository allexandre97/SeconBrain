...
- SRC-0045 reports that default OpenFE reached weighted all-to-all pairwise RMSE about 1.72 kcal/mol on 58 public systems and about 2.44 kcal/mol on 37 blinded private systems. [SRC-0045, abstract and section 3.1.1]
- Edgewise errors can be optimistic because transformation networks preferentially connect similar ligands; all-to-all pairwise $\Delta\Delta G$ metrics better represent arbitrary ligand-to-ligand comparisons within a series. [SRC-0045, section 3.1.1] [SRC-0046, metrics]
- Manual preparation choices such as protonation, tautomer, binding pose, rotamer, water sampling, and atom mapping can materially affect reported FEP accuracy. [SRC-0046, discussion] [SRC-0045, section 4.1]
...
Weighted benchmark RMSE aggregation: [SRC-0045, eq. 3] [SRC-0046, eq. 3]
...
- Curated public benchmark accuracy may not transfer directly to private active-project datasets containing assay-limit, stereochemical, tautomeric, pose, water-sampling, metal, or large-transformation issues. [SRC-0045, section 4.2]
